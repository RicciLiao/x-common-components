package ricciliao.common.component.cache.service;
...
public class CacheRestService<T extends CacheDto> {

    public CacheRestService(ConsumerCacheProperties.OperationProperties props,
